                        ...
                        <div class="col-lg-3">
                            <div class="d-flex justify-content-end pt-3">
                                ...
                                <a class="btn btn-outline-secondary me-2 btn-md-square rounded-circle"
                                    href="https://www.facebook.com/cotem.khong.90?locale=vi_VN"><i
                                        class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-outline-secondary me-2 btn-md-square rounded-circle"
                                    href="https://www.youtube.com/channel/UC0nXI6o5oM9yFGLd_JP_r9A"><i
                                        class="fab fa-youtube"></i></a>
                                <a class="btn btn-outline-secondary btn-md-square rounded-circle"
                                    href="https://www.linkedin.com/in/ho%C3%A0ng-t%E1%BA%A5n-d%C5%A9ng-7049b32a1/"><i
