...
public class ProductService {
    ...
    public Page<Product> fetchProductPaginationWithSpec(Pageable page, String name) {
        return this.productRepository.findAll(ProductSpecs.nameLike(name), page);
    }

    // case 1
    // public Page<Product> fetchProductPaginationWithSpec(Pageable page, double
    // min) {
    ...
    // case 3
    // public Page<Product> fetchProductPaginationWithSpec(Pageable page, String
    // factory) {
    ...
    // case 4
    // public Page<Product> fetchProductPaginationWithSpec(Pageable page,
    // List<String>
    // factory) {
